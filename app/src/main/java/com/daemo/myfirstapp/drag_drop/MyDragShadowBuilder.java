...
class MyDragShadowBuilder extends View.DragShadowBuilder {
    ...
    public void onProvideShadowMetrics(Point size, Point touch) {
        ...
        // The drag shadow is a ColorDrawable.
        // This sets its dimensions to be the same as the Canvas that the system will provide.
        // As a result, the drag shadow will fill the Canvas.
