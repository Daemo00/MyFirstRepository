...
public class ChatConnection {
    ...
    public void sendMessage(String msg) {
        if (mChatClient != null) mChatClient.sendMessage(msg);
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    while (!Thread.currentThread().isInterrupted()) {
                        Log.d(Utils.getTag(this), "ServerSocket Created, awaiting connection");
                        setSocket(mServerSocket.accept());
                        Log.d(Utils.getTag(this), "Connected.");
                        if (mChatClient == null) {
                    ...
                    Log.e(Utils.getTag(this), "Error creating ServerSocket: ", e);
                    e.printStackTrace();
                }
            }
        }
