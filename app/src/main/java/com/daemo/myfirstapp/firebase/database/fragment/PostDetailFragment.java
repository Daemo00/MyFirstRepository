...
public class PostDetailFragment extends MySuperFragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String mPostKey = getArguments().getString(EXTRA_POST_KEY);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        // Initialize Views
        mAuthorView = (TextView) view.findViewById(R.id.post_author);
        mTitleView = (TextView) view.findViewById(R.id.post_title);
        mBodyView = (TextView) view.findViewById(R.id.post_body);
        mCommentField = (EditText) view.findViewById(R.id.field_comment_text);
        Button mCommentButton = (Button) view.findViewById(R.id.button_post_comment);
    ...
    public void onStart() {
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Log.w(Utils.getTag(this), "loadPost:onCancelled", databaseError.toException());
                getMySuperActivity().showToast("Failed to load post.");
            }
        };
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.button_post_comment) postComment();
    }
        ...
        CommentAdapter(final Context context, DatabaseReference ref) {
            ...
            ChildEventListener childEventListener = new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                    Log.d(Utils.getTag(this), "onChildAdded:" + dataSnapshot.getKey());
                ...
                public void onChildChanged(DataSnapshot dataSnapshot, String previousChildName) {
                    Log.d(Utils.getTag(this), "onChildChanged:" + dataSnapshot.getKey());
                    ...
                    if (commentIndex > -1) {
                        ...
                        Log.w(Utils.getTag(this), "onChildChanged:unknown_child:" + commentKey);
                    }
                    // [END_EXCLUDE]
                }
                ...
                public void onChildRemoved(DataSnapshot dataSnapshot) {
                    Log.d(Utils.getTag(this), "onChildRemoved:" + dataSnapshot.getKey());
                    ...
                    if (commentIndex > -1) {
                        ...
                        Log.w(Utils.getTag(this), "onChildRemoved:unknown_child:" + commentKey);
                    }
                    // [END_EXCLUDE]
                }
                ...
                public void onChildMoved(DataSnapshot dataSnapshot, String previousChildName) {
                    Log.d(Utils.getTag(this), "onChildMoved:" + dataSnapshot.getKey());
                ...
                @Override
                public void onCancelled(DatabaseError databaseError) {
                    Log.w(Utils.getTag(this), "postComments:onCancelled", databaseError.toException());
